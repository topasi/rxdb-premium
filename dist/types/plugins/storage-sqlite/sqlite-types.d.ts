import type { MangoQuery, RxDocumentData, RxJsonSchema } from 'rxdb/plugins/core';
/**
...
export type SQLiteInternals = {
    ...
    /**
     * Indexes are created lazy,
     * await this promise before you run any
     * count or query() operation.
     */
    indexCreationPromise: Promise<void>;
};
